...
static void usage(void) {
   printf("usage: ethtoolStatTable [-D<tokens>] [-f] [-L] [-M] [-H] [LISTENING ADDRESSES]\n"
...
main (int argc, char **argv) {
  ...
  while ((ch = getopt(argc, argv, "D:fHLMx:")) != EOF)
    ...
    case 'H':
      ...
      init_agent("ethtoolStatTable");        /* register our .conf handlers */
      init_ethtoolStatTable();  
      init_snmp("ethtoolStatTable");
  ...
  init_agent("ethtoolStatTable");

  /* init ethtoolStatTable mib code */
  init_ethtoolStatTable();  

  /* read ethtoolStatTable.conf files. */
  init_snmp("ethtoolStatTable");
  ...
  /* at shutdown time */
  snmp_shutdown("ethtoolStatTable");
  SOCK_CLEANUP;
  exit(0);
}
