...
begin with the ethtoolStatTable prefix.
...
------------------------------------------------------------------------
  ...
  File    : ethtoolStatTable_Makefile
  ----------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f ethtoolStatTable_Makefile


  File    : ethtoolStatTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   ethtoolStatTable-README-ethtoolStatTable.txt
...
------------------------------------------------------------------------
  ...
  File    : ethtoolStatTable_interface.c
